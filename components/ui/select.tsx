...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // PROJECT OVERRIDE (h-10 -> h-11): this trigger carries the coverage-type
      // and agency-size fields on the mobile book-a-demo form, and 40px is under
      // the 44px touch minimum. Reapply after any `shadcn add select`.
